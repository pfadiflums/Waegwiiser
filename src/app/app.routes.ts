...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./feature/auth/oauth2-redirect/oauth2-redirect').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'stufe/:slug',
        loadComponent: () =>
          import('./feature/stufe-detail/stufe-detail').then((m) => m.StufeDetailComponent),
      },
      {
        path: 'join',
      ...
      },
      {
        path: 'downloads',
        loadComponent: () =>
          import('./feature/downloads/downloads').then((m) => m.DownloadsComponent),
      },
      {
        path: 'photos',
      ...
      },
      {
        path: 'pfadihaus',
        loadComponent: () =>
          import('./feature/pfadihaus/pfadihaus').then((m) => m.PfadihausComponent),
      },
      {
        path: 'impressum',
        loadComponent: () =>
          import('./feature/impressum/impressum').then((m) => m.ImpressumComponent),
      },
      {
        path: 'datenschutz',
        loadComponent: () =>
          import('./feature/datenschutz/datenschutz').then((m) => m.DatenschutzComponent),
      },
    ],
  },
  { path: '**', redirectTo: '' },
