...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-HGD4YT5A.js").then((m) => m.Home)
  }
];
...
function Navbar_For_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r1.path)("routerLinkActiveOptions", \u0275\u0275pureFunction1(3, _c0, item_r1.path === "/"));
    \u0275\u0275advance();
...
var Navbar = class _Navbar {
  navItems = [
    ...
    { label: "\xDCBER UNS", path: "/ueber-uns" },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Navbar, selectors: [["app-navbar"]], decls: 7, vars: 0, consts: [[1, "navbar"], [1, "nav-content"], [1, "nav-links"], [1, "logo"], ["src", "assets/images/logo.svg", "alt", "Pfadi St. Justus Logo"], ["routerLinkActive", "active", 3, "routerLink", "routerLinkActiveOptions"]], template: function Navbar_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "nav", 0)(1, "div", 1)(2, "ul", 2);
      \u0275\u0275repeaterCreate(3, Navbar_For_4_Template, 3, 5, "li", null, _forTrack0);
      \u0275\u0275elementEnd();
  ...
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Navbar, [{
    ...
    args: [{ selector: "app-navbar", changeDetection: ChangeDetectionStrategy.OnPush, imports: [RouterLink, RouterLinkActive], template: `    <nav class="navbar">
      <div class="nav-content">
        ...
        <div class="logo">
          <img src="assets/images/logo.svg" alt="Pfadi St. Justus Logo" />
        </div>
      </div>
    </nav>
`, styles: ['/* src/app/components/navbar/navbar.scss */\n.navbar {\n  position: sticky;\n  top: 0;\n  z-index: 100;\n  background: #F7F5EE;\n  padding: 2rem 0;\n}\n.nav-content {\n  max-width: 1440px;\n  margin: 0 auto;\n  padding: 0 clamp(2rem, 5vw, 4rem);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  gap: 2rem;\n}\n@media (min-width: 1921px) {\n  .nav-content {\n    max-width: 1920px;\n  }\n}\n.nav-links {\n  display: flex;\n  gap: clamp(1.5rem, 3vw, 3rem);\n  list-style: none;\n  margin: 0;\n  padding: 0;\n  flex: 1;\n}\n.nav-links a {\n  font-family: "Outfit", sans-serif;\n  font-weight: 700;\n  font-size: clamp(14px, 1.1vw, 16px);\n  line-height: 20px;\n  text-transform: uppercase;\n  color: #000000;\n  text-decoration: none;\n  transition: color 0.3s ease;\n  white-space: nowrap;\n}\n.nav-links a:hover,\n.nav-links a.active {\n  color: #EAC04A;\n}\n.logo {\n  height: 137px;\n  flex-shrink: 0;\n}\n.logo img {\n  height: 100%;\n  width: auto;\n  object-fit: contain;\n}\n@media (max-width: 1024px) {\n  .nav-content {\n    flex-direction: column;\n    text-align: center;\n  }\n  .logo {\n    height: 100px;\n  }\n  .nav-links {\n    flex-wrap: wrap;\n    justify-content: center;\n  }\n}\n/*# sourceMappingURL=navbar.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Navbar, { className: "Navbar", filePath: "src/app/components/navbar/navbar.ts", lineNumber: 12 });
})();

// src/app/app.ts
var App = class _App {
  title = signal("Waegwiiser", ...ngDevMode ? [{ debugName: "title" }] : []);
